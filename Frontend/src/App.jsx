...
const UpdatePlacementProfile = lazy(() =>
  import("./components/Students/UpdatePlacementProfile.jsx")
);
const UpdateJobStatus = lazy(() =>
  import("./components/Students/UpdateJobStatus.jsx")
);
const AddInternship = lazy(() =>
  import("./components/Students/AddInternship.jsx")
);
...
const StudentAccYearTPO = lazy(() =>
  import("./components/TPO/StudentYearAndBranchView.jsx")
);
const PostJobTPO = lazy(() => import("./components/TPO/PostJob.jsx"));
const AddNewUser = lazy(() => import("./components/SuperUser/AddNewUser.jsx"));
...
const ListAllTPO = lazy(() => import("./components/SuperUser/ListAllTPO.jsx"));
// super user
const LoginSuperUser = lazy(() => import("./components/SuperUser/Login.jsx"));
const ManagementSuperUser = lazy(() =>
  import("./components/SuperUser/AddManagement.jsx")
);
const StudentSuperUser = lazy(() =>
  import("./components/SuperUser/AddStudent.jsx")
);
...
const ViewAllInternship = lazy(() =>
  import("./components/ViewAllInternship.jsx")
);
...
function Layout({ header }) {
  ...
  const isSidebarOpenFromStorage =
      ...
      <BrowserRouter>
        <Suspense fallback={<LoadingComponent />}>
          <Routes>
            ...
            >
              ...
              <Route element={<Layout header="Placement Profile" />}>
                <Route
                  ...
                  element={<UpdatePlacementProfile />}
                />
              </Route>
              {/* update status of job */}
              <Route
                element={<Layout header="Update Job Application Status" />}
              >
                <Route
                  path="/student/status/:jobId"
                  element={<UpdateJobStatus />}
                />
              </Route>
              ...
              <Route element={<Layout header="Update Internship Details" />}>
                <Route
                  path="/student/add-internship/:internshipId"
                  element={<AddInternship />}
                />
              </Route>
              {/* view notice */}
            ...
            >
              <Route
                path="/tpo/complete-profile/:userId"
                element={<UserDetails />}
              />
              <Route element={<Layout header="Dashboard" />}>
              ...
              <Route element={<Layout header="Edit Company Detail" />}>
                <Route
                  path="/tpo/add-company/:companyId"
                  element={<AddCompany />}
                />
              </Route>
              {/* all notice */}
            ...
            <Route
              element={
                <UserProvider>
                  <ProtectedRoute allowedRoles={["management_admin"]} />
                </UserProvider>
              }
            >
              <Route
                path="/management/complete-profile/:userId"
                element={<UserDetails />}
              />
              ...
              <Route element={<Layout header="Edit Company Detail" />}>
                <Route
                  path="/management/add-company/:companyId"
                  element={<AddCompany />}
                />
              </Route>
              {/* all jobs post */}
              ...
              <Route element={<Layout header="Edit Job Detail" />}>
                <Route
                  path="/management/post-job/:jobId"
                  element={<PostJobTPO />}
                />
              </Route>
              {/* all notice */}
              ...
              <Route element={<Layout header="Notice" />}>
                <Route
                  path="/management/notice/:noticeId"
                  element={<ViewNotice />}
                />
              </Route>
              {/* send notice */}
            ...
            >
              ...
              <Route element={<Layout header="Edit Company Detail" />}>
                <Route
                  path="/admin/add-company/:companyId"
                  element={<AddCompany />}
                />
              </Route>
              {/* all jobs post */}
