...
function LoginManagement() {
  document.title = 'StuMate | Management Login';
  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center h-screen bg-black">
        <form className="rounded-xl bg-black/80 border border-green-500/20 p-8 shadow-lg space-y-6 w-1/3 max-lg:w-2/3 max-md:w-3/4 max-[400px]:w-4/5" onSubmit={handleSubmit}>
          <div className='text-center'>
            <img className="mb-4 rounded-xl w-20 h-20 mx-auto" src={Logo} alt="Logo" />
            <h1 className="text-xl font-extrabold text-green-500">Management Login</h1>
          </div>

          <div className="space-y-2">
            <label htmlFor="inputEmail" className="text-sm text-green-500/80">Email Address</label>
            <input
              type="email"
              id="inputEmail"
              name="email"
          ...
          <div className="space-y-2">
            <label htmlFor="inputPassword" className="text-sm text-green-500/80">Password</label>
            <div className="relative">
              ...
              />
              <i
                className={`absolute top-1/2 right-4 transform -translate-y-1/2 cursor-pointer ${isEyeOpen ? "fa-solid fa-eye text-green-500" : "fa-regular fa-eye-slash text-green-500"}`}
                onClick={handleEye}
              ></i>
            </div>
