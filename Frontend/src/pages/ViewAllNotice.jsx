    ...
    <>
...

      {
        loading ? (
          ...
          <>
            <div className=''>
              <Table striped bordered hover className='bg-black my-6 rounded-lg shadow w-full text-base max-sm:text-sm'>
                <thead>
                  <tr>
                      ...
                      <tr key={notice?._id}>
                        ...
                        <td>
                          <Link
                            ...
                            className='no-underline text-green-500 hover:text-green-700'
                          >
                            {notice?.title}
                            {(new Date() - new Date(notice?.createdAt)) / (1000 * 60 * 60 * 24) <= 2 && (
                              <Badge className="mx-2" bg="success">New</Badge>
                            )}
                          </Link>
                        </td>
                        {
