    ...
    const fetchAllData = async () => {
      try {
        ...
        if (studentDataRes.data?.studentProfile?.appliedJobs) {
          ...
          const rejectCount = appliedJobs.filter(
        ...
        if (placement.jobId) {
          const jobDetailResponse = await axios.get(
            `${BASE_URL}/tpo/job/${placement.jobId}`,
            {
              headers: { Authorization: `Bearer ${token}` },
            }
          );
          ...
          if (jobDetailResponse.data.company) {
            const companyResponse = await axios.get(
              `${BASE_URL}/company/company-data?companyId=${jobDetailResponse.data.company}`,
              {
                headers: { Authorization: `Bearer ${token}` },
              }
            );
    ...
    <>
      {loading ? (
        ...
        <>
          ...
          <div className="my-8 grid grid-cols-2 gap-4 text-base max-sm:text-sm max-md:grid-cols-1 bg-black">
            <div className="backdrop-blur-md bg-black border-gray-200 rounded-lg shadow p-6 h-fit max-md:p-3">
              <h3 className="text-2xl max-md:text-xl font-semibold text-gray-800 mb-4">
                Personal Details
              </h3>
                ...
                <div className="space-y-4">
                  ...
                  {userData?.studentProfile?.isApproved && (
                    <div>
                      ...
                      <span className="text-gray-800">
                        {userData?.studentProfile?.isApproved === true
                          ? "Yes"
                          : "No"}
                      </span>
                    </div>
                      ...
                      <div className="py-2 px-2  max-sm:text-sm">
                        <span className="bg-blue-500 py-1 pr-2 rounded cursor-pointer hover:bg-blue-700">
                          <a
                            href={
                              BASE_URL +
                              userData?.studentProfile?.resume?.filepath
                            }
                            target="_blanck"
            ...
            {userData?.role === "student" && (
              <>
                {/* placement status  */}
                <div
                  className={`backdrop-blur-md bg-white/30 border border-gray-200 rounded-lg shadow p-6 h-fit ${
                    placement?.isPlaced === true ? "bg-green-200" : "bg-red-200"
                  } max-md:p-3`}
                >
                  <div className="">
                    <h3 className="text-2xl max-md:text-xl font-semibold text-gray-800 mb-4">
                                ...
                                >
                                  ...
                                  <Accordion.Body>
                                    <Table striped borderless hover sixe="sm">
                                      ...
                                      <tbody>
                                        {userData?.studentProfile?.appliedJobs
                                          ?.length > 0 ? (
                                          userData?.studentProfile?.appliedJobs?.map(
                                            (job, index) => {
                                              const applicant =
                                                job.jobId?.applicants?.find(
                                                  (applicant) =>
                                                    applicant.studentId ===
                                                    userData._id
                                                );
                            ...
                            <div className="space-y-4">
                              ...
                              {userData?.studentProfile?.year && (
                                <div>
                                  ...
                                  <span className="text-gray-800">
                                    {userData?.studentProfile?.year}
                                    {userData?.studentProfile?.year === 1 &&
                                      "st"}
                                    {userData?.studentProfile?.year === 2 &&
                                      "nd"}
                                    {userData?.studentProfile?.year === 3 &&
                                      "rd"}
                                    {userData?.studentProfile?.year === 4 &&
                                      "th"}
                                  </span>
                                </div>
                              )}
                              ...
                              <div>
                                ...
                                <span className="text-gray-800">
                                  {userData?.studentProfile?.gap === true
                                    ? "Yes"
                                    : "No"}
                                </span>
                              </div>
                              ...
                              <div className="space-y-1 pl-2">
                                ...
                                {userData?.studentProfile?.pastQualification
                                  ...
                                  <div>
                                    ...
                                    <span className="text-gray-800">
                                      {userData?.studentProfile
                                        ?.pastQualification?.ssc?.percentage +
                                        "%"}
                                    </span>
                                  </div>
                                )}
                              ...
                              <div className="space-y-1 pl-2">
                                ...
                                {userData?.studentProfile?.pastQualification
                                  ...
                                  <div>
                                    ...
                                    <span className="text-gray-800">
                                      {userData?.studentProfile
                                        ?.pastQualification?.hsc?.percentage +
                                        "%"}
                                    </span>
                                  </div>
                                )}
                                ...
                                {userData?.studentProfile?.pastQualification
                                  ...
                                  <div>
                                    ...
                                    <span className="text-gray-800">
                                      {
                                        userData?.studentProfile
                                          ?.pastQualification?.diploma?.year
                                      }
                                    </span>
                                  </div>
                                )}
            ...
            {/* Internship details  */}
            {userData?.studentProfile?.internships &&
                          ...
                          <Accordion.Item eventKey={"1"} className="shadow-md">
                            ...
                            <Accordion.Body>
                              <Table striped borderless hover>
                                ...
                                <tbody>
                                  {userData?.studentProfile?.internships?.map(
                                    (internship, index) => (
