      ...
      <div className="flex justify-center items-center min-h-screen bg-black">
        ...
        >
          <div className="text-center">
            ...
            <h1 className="text-xl font-extrabold text-green-500">Super User Login</h1>
          </div>
          ...
          <div className="space-y-2">
            <label htmlFor="inputPassword" className="text-sm text-green-500/80">
              Password
            </label>
            <div className="relative">
              ...
              <i
                className={`absolute top-1/2 right-4 transform -translate-y-1/2 cursor-pointer ${
                  isEyeOpen ? "fa-solid fa-eye text-green-500" : "fa-regular fa-eye-slash text-green-500"
                }`}
                onClick={handleEye}
              ></i>
            </div>
