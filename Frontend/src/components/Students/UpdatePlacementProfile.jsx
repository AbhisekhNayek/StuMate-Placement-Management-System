          ...
          <div className="">
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-2 gap-4 my-4 text-base max-sm:text-sm">
                {/* basic info  */}
                <div className="grid backdrop-blur-md bg-black/80 border border-green-500/20 rounded-2xl shadow-lg p-6 max-md:col-span-2">
                  <span className="text-2xl max-sm:text-xl text-green-500">
                    Basic Details
                  </span>
                  <div className="flex flex-col justify-between py-2">
                    ...
                    <div className="flex justify-between">
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <span className="text-white">{userData?.number}</span>
                        </div>
                      ...
                      <Col
                        xs={5}
                        md={4}
                        className="flex justify-end items-start rounded"
                      >
                    ...
                    <div className="grid grid-cols-2">
                      {/* resume upload  */}
                      <div className="bg-black/80 border border-green-500/20 rounded-2xl p-2 shadow-lg">
                        <UploadResume
                      ...
                      {userData?.studentProfile?.resume?.filepath !==
                        ...
                        <div className="py-2 px-2">
                          <span className="bg-green-500 p-4 rounded cursor-pointer hover:bg-green-700">
                            <a
                              href={
                                BASE_URL +
                                userData?.studentProfile?.resume?.filepath
                ...
                {/* college info  */}
                <div className="backdrop-blur-md bg-black border border-white/20 rounded-lg shadow shadow-red-400 p-6 max-md:col-span-2">
                  <span className="text-green-500text-2xl max-sm:text-xl">
                    College Information
                  </span>
                  <div className="grid grid-cols-2">
                    {/* semester sgpa  */}
                      ...
                      <div className=" py-3 flex flex-wrap gap-2">
                        <FloatingLabel controlId="floatingSem1" label="Sem 1">
                          <Form.Control
                            ...
                            className="bg-black text-white border border-green-500 focus:ring-green-500"
                          />
                        </FloatingLabel>
                    ...
                    <div className="px-2 py-3 flex flex-col gap-3">
                      <FloatingLabel
                        ...
                        label="Current Year"
                        className="bg-black border-green-500 focus:ring-green-500"
                      >
                        <Form.Select
                          aria-label="Floating label select year"
                          className="cursor-pointer text-white bg-black border border-green-500 focus:ring-green-500"
                          name="year"
                ...
                {/* past qualification  */}
                <div className="col-span-2 bg-black bg-white/30 border border-white/20 rounded-lg shadow shadow-red-400 p-6">
              ...
              >
                <Button
                  ...
                  type="submit"
                  size="lg"
                  className="bg-green-500 border border-green-600 text-white hover:bg-green-600 focus:ring-green-400 mb-4"
                >
