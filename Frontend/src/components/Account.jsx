...
function Account() {
  ...
  const handlePassUpdate = async (e) => {
    ...
    if (!passData.oldpass || !passData.newpass || !passData.newcfmpass)
      return setPassData({ ...passData, error: "All Field Requied!" });

    if (!validatePassword(passData?.newpass))
      return setPassData({
        ...passData,
        error:
          "Password Must Contains: Minimum 8 Char with atleast 1 Special Char, 1 Number, 1 Uppercase, 1 Lowercase",
      });
    ...
    if (passData.newpass != passData.newcfmpass)
      return setPassData({
        ...passData,
        error: "New Password & Confirm New Password Didn't Matched",
      });
        ...
        <>
          ...
          <div className="max-sm:text-sm text-base">
            <div className="container grid grid-cols-3 gap-3 p-4 max-lg:grid-cols-2 max-sm:grid-cols-1">
              {/* Basic Details */}
              <div className="col-span-2 bg-black p-6 rounded-lg shadow-md w-full">
                <Form onSubmit={handleBasicDetailSubmit}>
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    >
                      <Form.Select
                        ...
                        className="cursor-pointer bg-black text-white border-gray-700"
                        name="gender"
                        value={
                  ...
                  <button
                    type="submit"
                    className="flex items-center my-2 px-3 py-2 bg-green-500 hover:bg-green-600 text-white rounded"
                  >
              ...
              {/* Address Box */}
              <div className="bg-black p-6 rounded-lg shadow-md w-full max-sm:col-span-2">
                <Form onSubmit={handleBasicDetailSubmit}>
              ...
              {/* Password Box */}
              <div className="bg-black p-6 rounded-lg shadow-md w-full col-span-2">
